...
ESM_MODEL_NAME = "/kaggle/input/esm2-t12-35m-ur50d/esm2_t12_35M_UR50D"

# BiomedBERT model for GO term text embedding
BIOMEDBERT_MODEL_NAME = "/kaggle/input/biomednlp-biomedbert-base-uncased-abstract/BiomedNLP-BiomedBERT-base-uncased-abstract"
...
NUM_NEGATIVE_SAMPLES = 500  # Number of negative samples per protein (recommended: 500-5000)
